--Lab5-1 创建函数calculateTotalSales 用来计算TotalDue的叠加和 SELECT * FROM来调用FUNCTION
USE "ZHU_MIBIN_TEST";
...
--Lab5-2 创建PROCEDURE 前面的@为直接创建变量 生命变量DECLARE @count BEGIN方法执行插数据操作
USE "ZHU_MIBIN_TEST";
...
--Lab5-3 PART2 CROSS APPLY方法调用函数 返回NAME
