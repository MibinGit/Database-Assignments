--Lab4.PartA.STEP1/STEP2 创建数据库
CREATE DATABASE "ZHU_MIBIN_TEST";

USE "ZHU_MIBIN_TEST";
--CREATE TABLE 创建数据库里面的表单并添加数据
...
--Lab4.PartA.STEP3 创建互相REFERENCES且拥有外键的表单
USE "ZHU_MIBIN_TEST";
...
--Lab4.PartB 输出的表单左侧为SalesOrderID 也就是外层SELECT和ORDER BY的对象 在一行输出的是ProductID 也就是STUFF对象以及RTRIM的CAST对象
...
--Lab4.PartC 选取ComponentLevel中Rank后排名第一的数据
USE AdventureWorks2008R2;
